...
const ResponsiveModalOverlay = (({ className, ...props }, ref) => (
...
const ResponsiveModalContent = (({ side = 'bottom', className, children, ...props }, ref) => (
...
const ResponsiveModalTitle =(({ className, ...props }, ref) => (
...
const ResponsiveModalDescription = (({ className, ...props }, ref) => (
